...
namespace apollo
{
    namespace prediction
    {
        ...
        using apollo_msgs::msg::ApollopredictionScenario;
        ...
        // detected obstacles.
        void ObstaclesContainer::Insert(const void* message)
        {
            PerceptionObstacles perception_obstacles;
            perception_obstacles=*(
                (const PerceptionObstacles *)(message));
            ...
            {
                timestamp = perception_obstacles.apolloheader.timestampsec;
            }
        ...
        void ObstaclesContainer::InsertPerceptionObstacle(
            const ApolloperceptionPerceptionObstacle &perception_obstacle, const double timestamp)
        {
            // Sanity checks.
        ...
        bool ObstaclesContainer::IsMovable(
            const ApolloperceptionPerceptionObstacle &perception_obstacle)
        {
            if ( perception_obstacle.type == apollo::perception::PerceptionObstacle::UNKNOWN_UNMOVABLE)
            {
                return false;
            }
            return true;
        ...
        const ApollopredictionScenario &ObstaclesContainer::curr_scenario() const
        {
