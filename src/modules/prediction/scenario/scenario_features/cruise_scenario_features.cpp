...
namespace apollo
{
    namespace prediction
    {
        ...
        {
            scenario_.set__type(Scenario::CRUISE);
        }
            ...
            const EnvironmentFeatures &environment_features)
        {
            ...
            for (const std::string &reverse_lane_id : reverse_lane_ids)
            {
                ...
                for (const auto &prede_id : reverse_lane_info->lane().predecessorid)
                {
            ...
            const double range)
        {
            ...
            while (!lane_queue.empty())
            {
                ...
                for (const auto prede_lane_id : lane.predecessorid)
                {
                ...
                for (const auto succ_lane_id : lane.successorid)
                {
