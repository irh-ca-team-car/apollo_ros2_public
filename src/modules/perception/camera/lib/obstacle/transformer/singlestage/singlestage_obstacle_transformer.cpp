  ...
  namespace perception
  {
    namespace camera
    {
          ...
          const ObstacleTransformerInitOptions &options)
      {
        ...
        if (!cyber::common::GetProtoFromASCIIFile(transformer_config,
                                                  &singlestage_param_))
        {
        ...
        AINFO_EVERY(60000) << "Load transformer parameters from " << transformer_config
              << " \nmin dimension: " << singlestage_param_.mindimensionval
              << " \ndo template search: " << singlestage_param_.checkdimension;
          ...
          base::ObjectSubType sub_type, float *dimension_hwl)
      {
        ...
        case base::ObjectSubType::BUS:
          ...
          break;
        default:
          if (min_dimension_val < singlestage_param_.mindimensionval)
          {
            common::IScale3(dimension_hwl, singlestage_param_.mindimensionval *
                                                                ...
                                                                int width)
      {
        ...
        {
          AERROR_EVERY(60000) << "Check predict bounding box, width or height is 0";
          return false;
        }
