  ...
  namespace perception
  {
    namespace lidar
    {
      ...
      bool GroundService::Init(const SceneServiceInitOptions &options)
      {
        ...
        config_file = GetAbsolutePath(config_file, "ground_service.json");
        ...
        double roi_region_rad_x = config_params.roiradx;
        double roi_region_rad_y = config_params.roirady;
        uint32_t rows = config_params.gridsize;
        uint32_t cols = config_params.gridsize;
