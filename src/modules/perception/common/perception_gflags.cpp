...
DEFINE_string(pfe_torch_file,
              "<root>/data/perception/production/data/perception/lidar/"
...
DEFINE_string(onnx_obstacle_detector_model,
              "<root>/modules/perception/camera"
...
DEFINE_string(onnx_test_input_path,
              "<root>/data/perception/inference"
