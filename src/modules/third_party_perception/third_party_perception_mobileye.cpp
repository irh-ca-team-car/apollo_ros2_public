...
namespace apollo
{
    namespace third_party_perception
    {
        ...
        ThirdPartyPerceptionMobileye::ThirdPartyPerceptionMobileye(
            apollo::cyber::ComponentBase *const node)
            : ThirdPartyPerception(node)
        {
            AINFO << "Init readers apollo::drivers::Mobileye";
            AINFO << FLAGS_mobileye_topic;
            ...
            AINFO << "Init readers apollo::drivers::DelphiESR";
            AINFO << FLAGS_delphi_esr_topic;
            ...
            AINFO << "Init readers apollo::drivers::ContiRadar";
            AINFO << FLAGS_conti_radar_topic;
        ...
        void ThirdPartyPerceptionMobileye::OnDelphiESR(const DelphiESR &message)
        {
            ...
            last_radar_obstacles_ = (current_radar_obstacles_);
            ...
            PerceptionObstacles *const response)
        {
            ...
            *response = fusion::EyeRadarFusion(eye_obstacles_, radar_obstacles_);
            ...
            node_->FillHeader(FLAGS_third_party_perception_node_name, response);

            eye_obstacles_.perceptionobstacle.clear();
            radar_obstacles_.perceptionobstacle.clear();
            return true;
        }
