...
PathTimeHeuristicOptimizer::PathTimeHeuristicOptimizer(const apollo_msgs::msg::ApolloplanningTaskConfig& config)
    : SpeedOptimizer(config) {
  ACHECK(config.taskconfig.speedheuristicoptimizerconfig != apollo_msgs::msg::ApolloplanningSpeedHeuristicOptimizerConfig());
  speed_heuristic_optimizer_config_ = config.taskconfig.speedheuristicoptimizerconfig;
}
...
bool PathTimeHeuristicOptimizer::SearchPathTimeGraph(
  ...
  const auto& dp_st_speed_optimizer_config =
      reference_line_info_->IsChangeLanePath()
          ? speed_heuristic_optimizer_config_.lanechangespeedconfig
          : speed_heuristic_optimizer_config_.defaultspeedconfig;
