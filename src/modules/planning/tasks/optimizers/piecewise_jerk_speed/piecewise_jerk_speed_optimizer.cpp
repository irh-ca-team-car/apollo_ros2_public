...
PiecewiseJerkSpeedOptimizer::PiecewiseJerkSpeedOptimizer(
  ...
  ACHECK(config_.taskconfig.piecewisejerkspeedoptimizerconfig != apollo_msgs::msg::ApolloplanningPiecewiseJerkSpeedOptimizerConfig());
}
...
Status PiecewiseJerkSpeedOptimizer::Process(const PathData& path_data,
  ...
  const auto& config = config_.taskconfig.piecewisejerkspeedoptimizerconfig;
  ...
  piecewise_jerk_problem.set_ddx_bounds(veh_param.maxdeceleration,
                                        veh_param.maxacceleration);
  piecewise_jerk_problem.set_dddx_bound(FLAGS_longitudinal_jerk_lower_bound,
                                        FLAGS_longitudinal_jerk_upper_bound);

  piecewise_jerk_problem.set_dx_ref(config.refvweight,
