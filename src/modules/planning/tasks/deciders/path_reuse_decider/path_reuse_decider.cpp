...
namespace apollo
{
  namespace planning
  {
                                     ...
                                     ReferenceLineInfo *const reference_line_info)
    {
      ...
      if (!Decider::config_.taskconfig.pathreusedeciderconfig.reusepath)
      {
      ...
      auto *lane_change_status = &injector_->planning_context()
                                     ...
                                     ->changelane;
      ADEBUG << "lane change status: " << lane_change_status;
  ...
  */
      ...
      if (is_change_lane_path && !lane_change_status->iscurrentoptsucceed)
      {
        reference_line_info->set_path_reusable(false);
      ...
      if (path_reusable_)
      {
        if (!frame->current_frame_planned_trajectory().isreplan &&
        ...
        ReferenceLineInfo *const reference_line_info, double *blocking_obstacle_s)
    {
      ...
      *blocking_obstacle_s = obstacle_sl.starts;
      ADEBUG << "blocking obstacle distance: " << obstacle_sl.starts;
      return true;
    }
        ...
        ReferenceLineInfo *const reference_line_info)
    {
           ...
           reference_line_info->path_decision()->obstacles().Items())
      {
        ...
        if ((obstacle_sl.ends < adc_position_sl.s - kSBuffer) ||
            // Ignore too small obstacles.
            (obstacle_sl.ends - obstacle_sl.starts) *
        ...
        Frame *frame, ReferenceLineInfo *const reference_line_info)
    {
      ...
      common::PathPoint history_init_path_point =
          history_planning_start_point.pathpoint;
      ...
      common::PathPoint init_path_point = planning_start_point.pathpoint;
      ...
      reference_line.XYToSLPB(init_path_point, &init_path_position_sl);
      ...
      for (size_t i = path_start_index; i < history_path.size(); ++i)
      {
        ...
        //          << "]. s[" << history_path[i].s() << "]";
        // }
        trimmed_path.back().set__s(updated_s);
      }
