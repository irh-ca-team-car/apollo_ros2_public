...
bool DualVariableWarmStartProblem::Solve(
  ...
  if (planner_open_space_config_.dualvariablewarmstartconfig
          .qpformat == OSQP) {
  ...
  } else if (planner_open_space_config_.dualvariablewarmstartconfig
                 .qpformat == SLACKQP) {
    ...
    app->Options()->SetIntegerValue(
        "print_level",
        planner_open_space_config_.dualvariablewarmstartconfig
            .ipoptconfig
            .ipoptprintlevel);
    app->Options()->SetIntegerValue(
        "mumps_mem_percent",
    ...
    app->Options()->SetNumericValue(
        ...
        planner_open_space_config_.dualvariablewarmstartconfig
            ...
            .mumpspivtol);
    app->Options()->SetIntegerValue(
        "max_iter", planner_open_space_config_.dualvariablewarmstartconfig
                        .ipoptconfig
                        .ipoptmaxiter);
    app->Options()->SetNumericValue(
        "tol", planner_open_space_config_.dualvariablewarmstartconfig
                   .ipoptconfig
                   .ipopttol);
    app->Options()->SetNumericValue(
    ...
    app->Options()->SetStringValue(
        ...
        planner_open_space_config_.dualvariablewarmstartconfig
            ...
            .ipoptalphafory);
    app->Options()->SetStringValue(
        "recalc_y", planner_open_space_config_.dualvariablewarmstartconfig
                        .ipoptconfig
                        .ipoptrecalcy);
