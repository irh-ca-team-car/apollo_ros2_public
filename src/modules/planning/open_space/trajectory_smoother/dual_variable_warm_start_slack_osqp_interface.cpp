...
DualVariableWarmStartSlackOSQPInterface::
  ...
  min_safety_distance_ =
      planner_open_space_config.dualvariablewarmstartconfig
          .minsafetydistance;
  check_mode_ =
      planner_open_space_config.dualvariablewarmstartconfig.debugosqp;
  beta_ = planner_open_space_config.dualvariablewarmstartconfig.beta;
  osqp_config_ =
      planner_open_space_config.dualvariablewarmstartconfig.osqpconfig;
}
...
bool DualVariableWarmStartSlackOSQPInterface::optimize() {
  ...
  settings->eps_abs = osqp_config_.epsabs;
  settings->eps_rel = osqp_config_.epsrel;
  settings->max_iter = osqp_config_.maxiter;
  settings->polish = osqp_config_.polish;
  settings->verbose = osqp_config_.osqpdebuglog;
