...
std::unique_ptr<Planner> NaviPlannerDispatcher::DispatchPlanner(
  ...
  if (planning_config.planningconfig.navigationplanningconfig != apollo_msgs::msg::ApolloplanningNavigationPlanningConfig()) {
    planner_type = (apollo::planning::PlannerType)planning_config.planningconfig.navigationplanningconfig.plannertype[0];
  }
