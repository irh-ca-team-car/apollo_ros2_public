...
bool ValetParkingScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.valetparkingconfig == apollo_msgs::msg::ApolloplanningScenarioValetParkingConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.valetparkingconfig);
  return true;
}
...
bool ValetParkingScenario::CheckDistanceToParkingSpot(
  ...
  hdmap::Id id;
  id.set__id(parking_space_overlap.object_id);
