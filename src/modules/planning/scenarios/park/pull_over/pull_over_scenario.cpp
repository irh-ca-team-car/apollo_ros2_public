...
bool PullOverScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.pulloverconfig == apollo_msgs::msg::ApolloplanningScenarioPullOverConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.pulloverconfig);
  return true;
}
