...
bool EmergencyStopScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.emergencystopconfig == apollo_msgs::msg::ApolloplanningScenarioEmergencyStopConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.emergencystopconfig);
  return true;
}
