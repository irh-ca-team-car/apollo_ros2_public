...
bool EmergencyPullOverScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.emergencypulloverconfig == apollo_msgs::msg::ApolloplanningScenarioEmergencyPullOverConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.emergencypulloverconfig);
  return true;
}
