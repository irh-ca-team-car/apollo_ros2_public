 ...
 */
                ...
                {
                    if (config_.scenarioconfig.bareintersectionunprotectedconfig == apollo_msgs::msg::ApolloplanningScenarioBareIntersectionUnprotectedConfig())
                    {
                        AERROR << "miss scenario specific config";
                        return false;
                    }
                    context_.scenario_config = config_.scenarioconfig.bareintersectionunprotectedconfig;
                    return true;
                }
