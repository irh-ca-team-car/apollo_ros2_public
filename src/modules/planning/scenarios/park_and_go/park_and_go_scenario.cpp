...
bool ParkAndGoScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.parkandgoconfig == apollo_msgs::msg::ApolloplanningScenarioParkAndGoConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.parkandgoconfig);
  return true;
}
