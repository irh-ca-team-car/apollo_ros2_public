...
bool StopSignUnprotectedScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.stopsignunprotectedconfig == apollo_msgs::msg::ApolloplanningScenarioStopSignUnprotectedConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.stopsignunprotectedconfig);
  return true;
}
