...
bool TrafficLightProtectedScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.trafficlightprotectedconfig != apollo_msgs::msg::ApolloplanningScenarioTrafficLightProtectedConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(config_.scenarioconfig.trafficlightprotectedconfig);
  return true;
}
