...
bool TrafficLightUnprotectedLeftTurnScenario::GetScenarioConfig() {
  if (config_.scenarioconfig.trafficlightunprotectedleftturnconfig == apollo_msgs::msg::ApolloplanningScenarioTrafficLightUnprotectedLeftTurnConfig())
  {
    AERROR << "miss scenario specific config";
    return false;
  }
  context_.scenario_config=(
      config_.scenarioconfig.trafficlightunprotectedleftturnconfig);
  return true;
}
