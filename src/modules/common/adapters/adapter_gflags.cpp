...
namespace apollo::common::gflags
{
    ...
    bool init_common_adapter(apollo::cyber::ComponentBase *ptr)
    {
        ptr_global = ptr;

        INIT_FLAG_bool(enable_adapter_dump, false,
                    "Whether enable dumping the messages to "
                    "/tmp/adapters/<topic_name>/<seq_num>.txt for debugging purposes.");
        INIT_FLAG_string(gps_topic, "/apollo/sensor/gnss/odometry", "GPS topic name");
        INIT_FLAG_string(imu_topic, "/apollo/sensor/gnss/corrected_imu", "IMU topic name");
        INIT_FLAG_string(raw_imu_topic, "/apollo/sensor/gnss/imu", "Raw IMU topic name");
        INIT_FLAG_string(audio_detection_topic, "/apollo/audio_detection",
                      "audio detection topic name");
        INIT_FLAG_string(chassis_topic, "/apollo/canbus/chassis", "chassis topic name");
        INIT_FLAG_string(chassis_detail_topic, "/apollo/canbus/chassis_detail",
                      "chassis detail topic name");
        INIT_FLAG_string(localization_topic, "/apollo/localization/pose",
                      "localization topic name");
        INIT_FLAG_string(planning_learning_data_topic, "/apollo/planning/learning_data",
                      "planning learning data");
        INIT_FLAG_string(planning_trajectory_topic, "/apollo/planning",
                      "planning trajectory topic name");
        INIT_FLAG_string(planning_pad_topic, "/apollo/planning/pad",
                      "planning pad topic name");
        INIT_FLAG_string(monitor_topic, "/apollo/monitor", "Monitor");
        INIT_FLAG_string(pad_topic, "/apollo/control/pad",
                      "control pad message topic name");
        INIT_FLAG_string(control_command_topic, "/apollo/control",
                      "control command topic name");
        INIT_FLAG_string(control_preprocessor_topic, "/apollo/control/preprocessor",
                      "control preprocessor topic name");
        INIT_FLAG_string(control_local_view_topic, "/apollo/control/localview",
                      "control local view topic name");
        INIT_FLAG_string(control_core_command_topic, "/apollo/control/controlcore",
                      "control command core algorithm topic name");
        INIT_FLAG_string(pointcloud_topic,
                      "/apollo/sensor/lidar128/compensator/PointCloud2",
                      "pointcloud topic name");
        INIT_FLAG_string(pointcloud_16_topic,
                      "/apollo/sensor/lidar16/compensator/PointCloud2",
                      "16 beam Lidar pointcloud topic name");
        INIT_FLAG_string(pointcloud_16_raw_topic,
                      "/apollo/sensor/lidar16/PointCloud2",
                      "16 beam Lidar raw pointcloud topic name");
        INIT_FLAG_string(pointcloud_16_front_up_topic,
                      "/apollo/sensor/lidar16/front/up/compensator/PointCloud2",
                      "Front up 16 beam Lidar pointcloud topic name");
        INIT_FLAG_string(pointcloud_64_topic,
                      "/apollo/sensor/velodyne64/compensator/PointCloud2",
                      "pointcloud topic name");
        INIT_FLAG_string(pointcloud_128_topic,
                      "/apollo/sensor/lidar128/compensator/PointCloud2",
                      "pointcloud topic name for 128 beam lidar");
        INIT_FLAG_string(pointcloud_hesai_40p_topic,
                      "/apollo/sensor/hesai40/compensator/PointCloud2",
                      "pointcloud topic name for hesai40p lidar");
        INIT_FLAG_string(pointcloud_raw_topic, "/apollo/sensor/velodyne64/PointCloud2",
                      "pointcloud raw topic name");
        INIT_FLAG_string(velodyne_raw_topic,
                      "/apollo/sensor/velodyne64/VelodyneScanUnified",
                      "velodyne64 raw data topic name");
        INIT_FLAG_string(pointcloud_fusion_topic,
                      "/apollo/sensor/velodyne64/fusion/PointCloud2",
                      "pointcloud fusion topic name");
        INIT_FLAG_string(vlp16_pointcloud_topic,
                      "/apollo/sensor/velodyne16/compensator/PointCloud2",
                      "16 beam Lidar pointcloud topic name");
        INIT_FLAG_string(lidar_16_front_center_topic,
                      "/apollo/sensor/lidar16/front/center/PointCloud2",
                      "front center 16 beam lidar topic name");
        INIT_FLAG_string(lidar_16_front_up_topic,
                      "/apollo/sensor/lidar16/front/up/PointCloud2",
                      "front up 16 beam lidar topic name");
        INIT_FLAG_string(lidar_16_rear_left_topic,
                      "/apollo/sensor/lidar16/rear/left/PointCloud2",
                      "rear left 16 beam lidar topic name");
        INIT_FLAG_string(lidar_16_rear_right_topic,
                      "/apollo/sensor/lidar16/rear/right/PointCloud2",
                      "rear right 16 beam lidar topic name");
        INIT_FLAG_string(lidar_16_fusion_topic,
                      "/apollo/sensor/lidar16/fusion/PointCloud2",
                      "16 beam lidar fusion topic name");
        INIT_FLAG_string(lidar_16_fusion_compensator_topic,
                      "/apollo/sensor/lidar16/fusion/compensator/PointCloud2",
                      "16 beam lidar fusion compensator topic name");
        INIT_FLAG_string(lidar_128_topic, "/apollo/sensor/lidar128/PointCloud2",
                      "128 beam lidar topic name");
        INIT_FLAG_string(prediction_topic, "/apollo/prediction", "prediction topic name");
        INIT_FLAG_string(prediction_container_topic, "/apollo/prediction_container",
                      "prediction container submodule topic name");
        INIT_FLAG_string(perception_obstacle_topic, "/apollo/perception/obstacles",
                      "perception obstacle topic name");
        INIT_FLAG_string(drive_event_topic, "/apollo/drive_event",
                      "drive event topic name");
        INIT_FLAG_string(traffic_light_detection_topic, "/apollo/perception/traffic_light",
                      "traffic light detection topic name");
        INIT_FLAG_string(perception_lane_mask_segmentation_topic,
                      "/apollo/perception/lane_mask",
                      "lane mask segmentation topic name");
        INIT_FLAG_string(routing_request_topic, "/apollo/routing_request",
                      "routing request topic name");
        INIT_FLAG_string(routing_response_topic, "/apollo/routing_response",
                      "routing response topic name");
        INIT_FLAG_string(routing_response_history_topic,
                      "/apollo/routing_response_history",
                      "routing response history topic name");
        INIT_FLAG_string(relative_odometry_topic, "/apollo/calibration/relative_odometry",
                      "relative odometry topic name");
        INIT_FLAG_string(ins_stat_topic, "/apollo/sensor/gnss/ins_stat",
                      "ins stat topic name");
        INIT_FLAG_string(ins_status_topic, "/apollo/sensor/gnss/ins_status",
                      "ins status topic name");
        INIT_FLAG_string(gnss_status_topic, "/apollo/sensor/gnss/gnss_status",
                      "gnss status topic name");
        INIT_FLAG_string(system_status_topic, "/apollo/monitor/system_status",
                      "System status topic name");
        INIT_FLAG_string(static_info_topic, "/apollo/monitor/static_info",
                      "Static info topic name");
        INIT_FLAG_string(mobileye_topic, "/apollo/sensor/mobileye", "mobileye topic name");
        INIT_FLAG_string(smartereye_obstacles_topic, "/apollo/sensor/smartereye/obstacles",
                      "smartereye obstacles topic name");
        INIT_FLAG_string(smartereye_lanemark_topic, "/apollo/sensor/smartereye/lanemark",
                      "smartereye lanemark topic name");
        INIT_FLAG_string(smartereye_image_topic, "/apollo/sensor/smartereye/image",
                      "smartereye image topic name");
        INIT_FLAG_string(delphi_esr_topic, "/apollo/sensor/delphi_esr",
                      "delphi esr radar topic name");
        INIT_FLAG_string(conti_radar_topic, "/apollo/sensor/conti_radar",
                      "continental radar topic name");
        INIT_FLAG_string(racobit_radar_topic, "/apollo/sensor/racobit_radar",
                      "racobit radar topic name");
        INIT_FLAG_string(ultrasonic_radar_topic, "/apollo/sensor/ultrasonic_radar",
                      "ultrasonic esr radar topic name");
        INIT_FLAG_string(front_radar_topic, "/apollo/sensor/radar/front",
                      "front radar topic name");
        INIT_FLAG_string(rear_radar_topic, "/apollo/sensor/radar/rear",
                      "rear radar topic name");
        // TODO(Authors): Change the topic name
        INIT_FLAG_string(compressed_image_topic, "camera/image_raw",
                      "CompressedImage topic name");
        INIT_FLAG_string(image_front_topic, "/apollo/sensor/camera/front_6mm/image",
                      "front camera image topic name for obstacles from camera");
        INIT_FLAG_string(image_short_topic,
                      "/apollo/sensor/camera/front_6mm/image/compressed",
                      "short camera image topic name");
        INIT_FLAG_string(image_long_topic, "/apollo/sensor/camera/traffic/image_long",
                      "long camera image topic name");
        INIT_FLAG_string(image_usb_cam_topic, "/apollo/sensor/camera/image_usb_cam",
                      "USB camera image topic name");
        INIT_FLAG_string(camera_image_long_topic, "/apollo/sensor/camera/image_long",
                      "long camera image topic name");
        INIT_FLAG_string(camera_image_short_topic, "/apollo/sensor/camera/image_short",
                      "short camera image topic name");
        INIT_FLAG_string(camera_front_6mm_topic, "/apollo/sensor/camera/front_6mm/image",
                      "front 6mm camera topic name");
        INIT_FLAG_string(camera_front_6mm_2_topic,
                      "/apollo/sensor/camera/front_6mm_2/image",
                      "front 6mm camera topic name 2");
        INIT_FLAG_string(camera_front_12mm_topic, "/apollo/sensor/camera/front_12mm/image",
                      "front 12mm camera topic name");
        INIT_FLAG_string(camera_front_6mm_compressed_topic,
                      "/apollo/sensor/camera/front_6mm/image/compressed",
                      "front 6mm camera compressed topic name");
        INIT_FLAG_string(camera_front_12mm_compressed_topic,
                      "/apollo/sensor/camera/front_12mm/image/compressed",
                      "front 12mm camera compressed topic name");
        INIT_FLAG_string(camera_left_fisheye_compressed_topic,
                      "/apollo/sensor/camera/left_fisheye/image/compressed",
                      "left fisheye camera compressed topic name");
        INIT_FLAG_string(camera_right_fisheye_compressed_topic,
                      "/apollo/sensor/camera/right_fisheye/image/compressed",
                      "right fisheye camera compressed topic name");
        INIT_FLAG_string(camera_rear_6mm_compressed_topic,
                      "/apollo/sensor/camera/rear_6mm/image/compressed",
                      "front 6mm camera compressed topic name");
        INIT_FLAG_string(camera_front_6mm_video_compressed_topic,
                      "/apollo/sensor/camera/front_6mm/video/compressed",
                      "front 6mm camera video compressed topic name");
        INIT_FLAG_string(camera_front_12mm_video_compressed_topic,
                      "/apollo/sensor/camera/front_12mm/video/compressed",
                      "front 12mm camera video compressed topic name");
        INIT_FLAG_string(camera_left_fisheye_video_compressed_topic,
                      "/apollo/sensor/camera/left_fisheye/video/compressed",
                      "left fisheye camera video compressed topic name");
        INIT_FLAG_string(camera_right_fisheye_video_compressed_topic,
                      "/apollo/sensor/camera/right_fisheye/video/compressed",
                      "right fisheye camera video compressed topic name");
        INIT_FLAG_string(camera_rear_6mm_video_compressed_topic,
                      "/apollo/sensor/camera/rear_6mm/video/compressed",
                      "front 6mm camera video compressed topic name");
        INIT_FLAG_string(gnss_rtk_obs_topic, "/apollo/sensor/gnss/rtk_obs",
                      "Gnss rtk observation topic name");
        INIT_FLAG_string(gnss_rtk_eph_topic, "/apollo/sensor/gnss/rtk_eph",
                      "Gnss rtk ephemeris topic name");
        INIT_FLAG_string(gnss_best_pose_topic, "/apollo/sensor/gnss/best_pose",
                      "Gnss rtk best gnss pose");
        INIT_FLAG_string(localization_gnss_topic, "/apollo/localization/msf_gnss",
                      "Gnss localization measurement topic name");
        INIT_FLAG_string(localization_lidar_topic, "/apollo/localization/msf_lidar",
                      "Lidar localization measurement topic name");
        INIT_FLAG_string(localization_ndt_topic, "/apollo/localization/ndt_lidar",
                      "NDT localization lidar measurement topic name");
        INIT_FLAG_string(localization_sins_pva_topic, "/apollo/localization/msf_sins_pva",
                      "Localization sins pva topic name");
        INIT_FLAG_string(localization_msf_status, "/apollo/localization/msf_status",
                      "msf localization status");
        INIT_FLAG_string(relative_map_topic, "/apollo/relative_map", "relative map");
        INIT_FLAG_string(navigation_topic, "/apollo/navigation", "navigation");
        INIT_FLAG_string(hmi_status_topic, "/apollo/hmi/status", "HMI status topic name.");
        INIT_FLAG_string(audio_capture_topic, "/apollo/hmi/audio_capture",
                      "HMI audio capture topic name.");
        INIT_FLAG_string(v2x_obu_traffic_light_topic,
                      "/apollo/v2x/obu/internal/traffic_light",
                      "v2x obu traffic_light topic name");
        INIT_FLAG_string(v2x_internal_obstacle_topic, "/apollo/v2x/obu/internal/obstacles",
                      "v2x internal obstacles topic name");
        INIT_FLAG_string(v2x_obstacle_topic, "/apollo/v2x/obstacles",
                      "v2x obstacles topic name");
        INIT_FLAG_string(v2x_traffic_light_topic, "/apollo/v2x/traffic_light",
                      "v2x traffic light topic name");
        INIT_FLAG_string(v2x_traffic_light_for_hmi_topic,
                      "/apollo/v2x/traffic_light/for_hmi",
                      "v2x traffic light topic name for hmi");
        INIT_FLAG_string(v2x_rsi_topic, "/apollo/v2x/rsi", "v2x rsi topic name");

        INIT_FLAG_string(storytelling_topic, "/apollo/storytelling",
                      "Storytelling topic.");
        INIT_FLAG_string(audio_event_topic, "/apollo/audio_event", "Audio event topic.");

        INIT_FLAG_string(guardian_topic, "/apollo/guardian", "Guardian topic.");
        INIT_FLAG_string(gnss_raw_data_topic, "/apollo/sensor/gnss/raw_data",
                      "gnss raw data topic name");
        INIT_FLAG_string(stream_status_topic, "/apollo/sensor/gnss/stream_status",
                      "gnss stream status topic name");
        INIT_FLAG_string(heading_topic, "/apollo/sensor/gnss/heading",
                      "gnss heading topic name");
        INIT_FLAG_string(rtcm_data_topic, "/apollo/sensor/gnss/rtcm_data",
                      "gnss rtcm data topic name");
        INIT_FLAG_string(tf_topic, "/tf", "Transform topic.");
        INIT_FLAG_string(tf_static_topic, "/tf_static", "Transform static topic.");
        INIT_FLAG_string(recorder_status_topic, "/apollo/data/recorder/status",
                      "Recorder status topic.");
        INIT_FLAG_string(latency_recording_topic, "/apollo/common/latency_records",
                      "Latency recording topic.");
        INIT_FLAG_string(latency_reporting_topic, "/apollo/common/latency_reports",
                      "Latency reporting topic.");
        INIT_FLAG_string(task_topic, "/apollo/task_manager", "task manager topic name");
        // value: velodyne128, velodyne64, velodyne16
        INIT_FLAG_string(lidar_model_version, "",
                      "It determins which lidar model(16 ,64 or 128) to load, "
                      "if not to set, the model will be loaded by the sensor name.");
        return true;
    }
