...
namespace apollo_msgs::msg {
    nlohmann::json to_json (const ApolloplanningDistanceApproachConfig &msg) {
        ...
        obj["distanceapproachmode"] = (msg.distanceapproachmode);
        obj["enablejacobianad"] = (msg.enablejacobianad);
        obj["enablecheckinitialstate"] = (msg.enablecheckinitialstate);
        obj["weightendstate"] = (msg.weightendstate);
        obj["weightslack"] = (msg.weightslack);
        return obj;
    }
    ApolloplanningDistanceApproachConfig from_json_ApolloplanningDistanceApproachConfig (nlohmann::json obj) {
        ApolloplanningDistanceApproachConfig msg;
        ...
        if(obj.contains("distanceapproachmode"))
        {
            msg.distanceapproachmode = (obj["distanceapproachmode"].is_string()?atoi(obj["distanceapproachmode"].get<std::string>().c_str()):obj["distanceapproachmode"].get<int>());
        }
        if(obj.contains("enablejacobianad"))
        {
            msg.enablejacobianad = (obj["enablejacobianad"].is_string()?(bool)atoi(obj["enablejacobianad"].get<std::string>().c_str()):obj["enablejacobianad"].get<bool>());
        }
        if(obj.contains("enablecheckinitialstate"))
        {
            msg.enablecheckinitialstate = (obj["enablecheckinitialstate"].is_string()?(bool)atoi(obj["enablecheckinitialstate"].get<std::string>().c_str()):obj["enablecheckinitialstate"].get<bool>());
        }
        if(obj.contains("weightendstate"))
        {
            msg.weightendstate = (obj["weightendstate"].is_string()?atof(obj["weightendstate"].get<std::string>().c_str()):obj["weightendstate"].get<double>());
        }
        if(obj.contains("weightslack"))
        {
            msg.weightslack = (obj["weightslack"].is_string()?atof(obj["weightslack"].get<std::string>().c_str()):obj["weightslack"].get<double>());
        }
        return msg;
    }
    template <>
    ApolloplanningDistanceApproachConfig from_json<ApolloplanningDistanceApproachConfig>(nlohmann::json obj){
        return from_json_ApolloplanningDistanceApproachConfig(obj);
    }
    nlohmann::json &operator>>(nlohmann::json &os, ApolloplanningDistanceApproachConfig &dt)
    {
        dt=from_json_ApolloplanningDistanceApproachConfig(os);
        return os;
    }
