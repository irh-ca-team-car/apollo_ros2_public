...
namespace apollo_msgs::msg {
    ...
    ApolloperceptioncamerayoloModelParam from_json_ApolloperceptioncamerayoloModelParam (nlohmann::json obj) {
        ApolloperceptioncamerayoloModelParam msg;
        ...
        if(obj.contains("dimensionstatistics"))
        {
            if(obj["dimensionstatistics"].is_array())
            {
                ...
                {
                    msg.dimensionstatistics.push_back(from_json_ApolloperceptioncamerayoloDimensionStatistics(element));
                }
            }
            else
            {
                msg.dimensionstatistics.push_back(from_json_ApolloperceptioncamerayoloDimensionStatistics(obj["dimensionstatistics"]));
            }
        }
        if(obj.contains("bboxstatistics"))
        {
            if(obj["bboxstatistics"].is_array())
            {
                ...
                {
                    msg.bboxstatistics.push_back(from_json_ApolloperceptioncamerayoloBBoxStatistics(element));
                }
            }
            else
            {
                msg.bboxstatistics.push_back(from_json_ApolloperceptioncamerayoloBBoxStatistics(obj["bboxstatistics"]));
            }
        }
    ...
    ApolloperceptioncamerayoloModelParam from_json<ApolloperceptioncamerayoloModelParam>(nlohmann::json obj){
        return from_json_ApolloperceptioncamerayoloModelParam(obj);
    }
    nlohmann::json &operator>>(nlohmann::json &os, ApolloperceptioncamerayoloModelParam &dt)
    {
        dt=from_json_ApolloperceptioncamerayoloModelParam(os);
        return os;
    }
