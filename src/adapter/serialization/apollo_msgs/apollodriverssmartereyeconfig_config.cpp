...
namespace apollo_msgs::msg {
    nlohmann::json to_json (const ApollodriverssmartereyeconfigConfig &msg) {
        ...
        obj["channelnameimage"] = (msg.channelnameimage);
        obj["channelnameimagecompressed"] = (msg.channelnameimagecompressed);
    ...
    ApollodriverssmartereyeconfigConfig from_json_ApollodriverssmartereyeconfigConfig (nlohmann::json obj) {
        ApollodriverssmartereyeconfigConfig msg;
        ...
        if(obj.contains("channelnameimage"))
        {
            msg.channelnameimage = (obj["channelnameimage"].is_string()?(obj["channelnameimage"].get<std::string>().c_str()):obj["channelnameimage"].get<std::string>());
        }
        if(obj.contains("channelnameimagecompressed"))
        {
            msg.channelnameimagecompressed = (obj["channelnameimagecompressed"].is_string()?(obj["channelnameimagecompressed"].get<std::string>().c_str()):obj["channelnameimagecompressed"].get<std::string>());
        }
    ...
    ApollodriverssmartereyeconfigConfig from_json<ApollodriverssmartereyeconfigConfig>(nlohmann::json obj){
        return from_json_ApollodriverssmartereyeconfigConfig(obj);
    }
    nlohmann::json &operator>>(nlohmann::json &os, ApollodriverssmartereyeconfigConfig &dt)
    {
        dt=from_json_ApollodriverssmartereyeconfigConfig(os);
        return os;
    }
