...
namespace apollo_msgs::msg {
    ...
    Apollov2xobuLaneTrafficLight from_json_Apollov2xobuLaneTrafficLight (nlohmann::json obj) {
        Apollov2xobuLaneTrafficLight msg;
        ...
        if(obj.contains("singletrafficlight"))
        {
            if(obj["singletrafficlight"].is_array())
            {
                ...
                {
                    msg.singletrafficlight.push_back(from_json_Apollov2xobuSingleTrafficLight(element));
                }
            }
            else
            {
                msg.singletrafficlight.push_back(from_json_Apollov2xobuSingleTrafficLight(obj["singletrafficlight"]));
            }
        }
        return msg;
    }
    ...
    Apollov2xobuLaneTrafficLight from_json<Apollov2xobuLaneTrafficLight>(nlohmann::json obj){
        return from_json_Apollov2xobuLaneTrafficLight(obj);
    }
    nlohmann::json &operator>>(nlohmann::json &os, Apollov2xobuLaneTrafficLight &dt)
    {
        dt=from_json_Apollov2xobuLaneTrafficLight(os);
        return os;
    }
