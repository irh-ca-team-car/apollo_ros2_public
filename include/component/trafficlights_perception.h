...
class TrafficLightsPerceptionComponent : public apollo::cyber::Component {
 public:
  TrafficLightsPerceptionComponent() : Component("TrafficLightsPerceptionComponent"){};
...
apollo::transform::Buffer* tf2_buffer_ =apollo::transform::Buffer::Instance();
  ...
  std::vector<apollo_msgs::msg::ApollohdmapSignal> last_signals_;
  ...
  std::vector<apollo::hdmap::Curve> stoplines_;
  ...
  std::shared_ptr<
      apollo::cyber::Writer<apollo_msgs::msg::ApolloperceptionTrafficLightDetection>>
      writer_;
