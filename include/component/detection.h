...
class DetectionComponent : public cyber::Component {
 public:
  DetectionComponent() : Component("DetectionComponent") {}
  virtual ~DetectionComponent() = default;

  bool Init() override;
  bool Proc(const std::shared_ptr<drivers::PointCloud>& message);
