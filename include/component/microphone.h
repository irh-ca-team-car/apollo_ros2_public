...
namespace apollo
{
    namespace drivers
    {
        namespace microphone
        {
            ...
            using apollo_msgs::msg::Bytes;

            class MicrophoneComponent : public Component
            {
            public:
                MicrophoneComponent():Component("Microphone"){}
                bool Init() override;
                ~MicrophoneComponent();
            ...
            private:
                ...
                std::vector<Bytes> channel_data_ptrs_;
                std::shared_ptr<MicrophoneConfig_> microphone_config_ptr_;
                char *buffer_;
