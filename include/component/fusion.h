...
class FusionComponent : public cyber::Component {
 public:
  FusionComponent() : Component("FusionComponent") {}
 ...
 private:
  ...
  std::shared_ptr<apollo::cyber::WriterJson<SensorFrameMessage>> inner_writer_;
  std::shared_ptr<apollo::cyber::ReaderJson<SensorFrameMessage>> sensframe_reader_;
};
