...
class FusionCameraDetectionComponent : public apollo::cyber::Component {
 ...
 public:
  FusionCameraDetectionComponent() : Component("FusionCameraDetectionComponent") {seq_num_=0;}
 ...
 private:
  ...
  std::vector<std::shared_ptr<cyber::NIComponent>> camera_listener_nodes_;
  std::vector<std::shared_ptr<apollo::cyber::Reader<apollo::drivers::Image>>> camera_listener_;
  ...
  std::shared_ptr<apollo::cyber::WriterJson<SensorFrameMessage>>
      sensorframe_writer_;

  std::shared_ptr<apollo::cyber::WriterJson<CameraPerceptionVizMessage>>
      camera_viz_writer_;
  ...
  std::shared_ptr<apollo::cyber::Reader<Motion_Service>> motion_service_reader;
