...
class RecognitionComponent : public cyber::Component {
 public:
  RecognitionComponent() : Component("RecognitionComponent") {tracker_=nullptr;}
 ...
 private:
  ...
  std::shared_ptr<apollo::cyber::ReaderJson<LidarFrameMessage>> reader_;
};
