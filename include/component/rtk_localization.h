...
class RTKLocalizationComponent final
 ...
 public:
  RTKLocalizationComponent() : Component("RTKLocalizationComponent") {localization_ = std::unique_ptr<RTKLocalization>(new RTKLocalization());}
  ~RTKLocalizationComponent() = default;

  bool Init() override;

  bool Proc(const std::shared_ptr<localization::Gps> &gps_msg);
