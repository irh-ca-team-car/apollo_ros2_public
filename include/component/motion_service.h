...
class MotionService : public apollo::cyber::Component {
 public:
  MotionService() : Component("MotionService"){}
 ...
 private:
  ...
  std::shared_ptr<apollo::cyber::Reader<apollo::drivers::Image>> camera_reader;
  std::shared_ptr<apollo::cyber::Reader<localization::LocalizationEstimate>> localization_reader;
  std::mutex mutex_;
