...
class OnlineVisualizerComponent final
 ...
 public:
  OnlineVisualizerComponent() : Component("OnlineVisualizerComponent") {}
  ...
  bool Proc(const std::shared_ptr<drivers::PointCloud> &msg);
 ...
 private:
  ...
  std::shared_ptr<cyber::Reader<drivers::PointCloud>> dag_reader_ =
      nullptr;
