...
class NDTLocalizationComponent final
 ...
 public:
  NDTLocalizationComponent() : Component("NDTLocalizationComponent") {localization_ = std::unique_ptr<NDTLocalization>(new NDTLocalization());}
  ~NDTLocalizationComponent() = default;

  bool Init() override;

  bool Proc(const std::shared_ptr<localization::Gps> &odometry_msg);
