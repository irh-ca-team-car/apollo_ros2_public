...
class PredictionComponent
 ...
 public:
   ...
   * @brief Destructor
   */
  PredictionComponent(): cyber::Component("PredictionComponent"){}
  ~PredictionComponent();
 ...
 private:
  ...
  std::shared_ptr<cyber::Reader<apollo_msgs::msg::ApolloplanningADCTrajectory>> planning_reader_;

  std::shared_ptr<cyber::Reader<localization::LocalizationEstimate>>
      localization_reader_;
std::shared_ptr<cyber::Reader<apollo_msgs::msg::ApolloperceptionPerceptionObstacles>> proc_reader_;
  ...
  std::shared_ptr<cyber::WriterJson<SubmoduleOutput>> container_writer_;

  std::shared_ptr<cyber::WriterJson<ADCTrajectoryContainer>> adc_container_writer_;
