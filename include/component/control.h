...
class ControlComponent final : public apollo::cyber::TimerComponent {
 ...
 private:
  ...
  void OnChassis(const std::shared_ptr<apollo_msgs::msg::ApollocanbusChassis> &chassis);
  ...
  private : apollo::cyber::Time init_time_;

  apollo_msgs::msg::ApollolocalizationLocalizationEstimate latest_localization_;
  apollo_msgs::msg::ApollocanbusChassis latest_chassis_;
  apollo_msgs::msg::ApolloplanningADCTrajectory latest_trajectory_;
  PadMessage pad_msg_;
  ...
  apollo_msgs::msg::ApollocontrolControlConf control_conf_;

  std::mutex mutex_;

  std::shared_ptr<cyber::Reader<apollo_msgs::msg::ApollocanbusChassis>> chassis_reader_;
  ...
  std::shared_ptr<cyber::Reader<apollo_msgs::msg::ApolloplanningADCTrajectory>>
      trajectory_reader_;
