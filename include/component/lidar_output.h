...
class LidarOutputComponent : public cyber::Component {
 public:
  LidarOutputComponent() : Component("LidarOutputComponent"){}
 ...
 private:
  ...
  std::shared_ptr<cyber::ReaderJson<SensorFrameMessage>> sensframe_reader_;
