 ...
 */
   ...
   */
                virtual bool Load(const apollo_msgs::msg::ApollopredictionLayerParameter &layer_pb);
   ...
   */
                virtual void SetState(const std::vector<Eigen::MatrixXf> &states) { (void)states; }

                /**
   * @brief Access to the internal state of a layer
   * @return Internal state in a vector of Eigen::MatrixXf
   */
                virtual void State(std::vector<Eigen::MatrixXf> *states) const {(void)states; }
 ...
 */
   ...
   */
                bool Load(const apollo_msgs::msg::ApollopredictionLayerParameter &layer_pb) override;
