...
DECLARE_int64(sample_size_for_average_lane_curvature);

// Validation checker
DECLARE_double(centripetal_acc_coeff);

// Junction Scenario
DECLARE_int64(junction_historical_frame_length);
...
namespace apollo
{
    void PredictionGFlags(apollo::cyber::ComponentBase *ptr);
}