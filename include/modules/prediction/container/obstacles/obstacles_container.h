...
class ObstaclesContainer : public Container {
 public:
   ...
   */
  void Insert(const void* message) override;
  ...
  const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& GetPerceptionObstacle(
      const int id);
   ...
   */
  const apollo_msgs::msg::ApollopredictionScenario& curr_scenario() const;
 ...
 private:
   ...
   */
  bool IsMovable(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle);
 ...
 private:
  ...
  apollo_msgs::msg::ApollopredictionScenario curr_scenario_;
