...
class Obstacle {
 public:
   ...
   */
  bool Insert(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
              const double timestamp, const int prediction_id);
  ...
  const apollo_msgs::msg::ApollopredictionObstacleConf &obstacle_conf() { return obstacle_conf_; }

  PredictionObstacle GeneratePredictionObstacle();

 private:
  void SetStatus(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
                 double timestamp, Feature* feature);

  bool SetId(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
             Feature* feature, const int prediction_id = -1);

  void SetType(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
               Feature* feature);
  ...
  void SetTimestamp(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
  ...
  void SetPosition(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
                   Feature* feature);

  void SetVelocity(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
                   Feature* feature);
  ...
  void SetTheta(const apollo_msgs::msg::ApolloperceptionPerceptionObstacle& perception_obstacle,
                Feature* feature);
  ...
  void SetLaneSequenceStopSign(apollo_msgs::msg::ApollopredictionLaneSequence *lane_sequence_ptr);
 ...
 public:
  ...
  apollo_msgs::msg::ApollopredictionObstacleConf obstacle_conf_;
