...
class ADCTrajectoryContainer : public Container {
 public:
   ...
   */
  bool HasOverlap(const apollo_msgs::msg::ApollopredictionLaneSequence &lane_sequence) const;
   ...
   */
  const apollo_msgs::msg::ApolloplanningADCTrajectory &adc_trajectory() const;
  ...
  void load_json(nlohmann::json obj);
...
private:
 ...
 private:
   apollo_msgs::msg::ApolloplanningADCTrajectory adc_trajectory_;
