...
class PoseContainer : public Container {
 public:
   ...
   */
  const apollo_msgs::msg::ApolloperceptionPerceptionObstacle* ToPerceptionObstacle();
 ...
 private:
   std::unique_ptr<apollo_msgs::msg::ApolloperceptionPerceptionObstacle> obstacle_ptr_;
};
