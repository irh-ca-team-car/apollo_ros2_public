...
class SequencePredictor : public Predictor {
 ...
 protected:
  ...
  double GetLaneChangeDistanceWithADC(
      const apollo_msgs::msg::ApollopredictionLaneSequence& lane_sequence, const Obstacle* ego_vehicle_ptr,
      const ADCTrajectoryContainer* adc_trajectory_container);
   ...
   */
  double GetLaneSequenceCurvatureByS(const apollo_msgs::msg::ApollopredictionLaneSequence &lane_sequence,
                                     const double s);
   ...
   */
  std::string ToString(const apollo_msgs::msg::ApollopredictionLaneSequence& sequence);
