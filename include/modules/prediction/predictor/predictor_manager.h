...
class PredictorManager {
 ...
 private:
  ...
  void InitVehiclePredictors(const apollo_msgs::msg::ApollopredictionObstacleConf& conf);

  void InitCyclistPredictors(const apollo_msgs::msg::ApollopredictionObstacleConf& conf);

  void InitDefaultPredictors(const apollo_msgs::msg::ApollopredictionObstacleConf& conf);
