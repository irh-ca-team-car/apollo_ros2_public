...
namespace apollo
{
   ...
   */
        ...
        private:
            ...
            double CentripetalAccelerationCost(const apollo_msgs::msg::ApollopredictionLaneSequence &lane_sequence,
                                               const double speed,
                                               const double acceleration);

            double CollisionWithEgoVehicleCost(const apollo_msgs::msg::ApollopredictionLaneSequence &lane_sequence,
                                               const double speed,
                                               const double acceleration);
