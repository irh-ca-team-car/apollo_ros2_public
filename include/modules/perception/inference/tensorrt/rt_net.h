...
const std::map<EltwiseParameter::EltwiseOp, nvinfer1::ElementWiseOperation>
    eltwise_map{
        {EltwiseParameter::EltwiseOp::PROD,
         nvinfer1::ElementWiseOperation::kPROD},
        {EltwiseParameter::EltwiseOp::SUM, nvinfer1::ElementWiseOperation::kSUM},
        {EltwiseParameter::EltwiseOp::MAX, nvinfer1::ElementWiseOperation::kMAX}};
