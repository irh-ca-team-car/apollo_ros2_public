  ...
  namespace perception
  {
    namespace inference
    {
      ...
      public:
        ...
        {
          heat_map_a_ = dfmb_psroi_align_parameter.heatmapa;
          output_channel_ = dfmb_psroi_align_parameter.outputdim;
          group_height_ = dfmb_psroi_align_parameter.groupheight;
          group_width_ = dfmb_psroi_align_parameter.groupwidth;
          pooled_height_ = dfmb_psroi_align_parameter.pooledheight;
          pooled_width_ = dfmb_psroi_align_parameter.pooledwidth;
          pad_ratio_ = dfmb_psroi_align_parameter.padratio;
          sample_per_part_ = dfmb_psroi_align_parameter.sampleperpart;

          trans_std_ = dfmb_psroi_align_parameter.transstd;
          part_height_ = dfmb_psroi_align_parameter.partheight;
          part_width_ = dfmb_psroi_align_parameter.partwidth;
          heat_map_b_ = dfmb_psroi_align_parameter.heatmapb;
