...
class VehicleStateProvider {
 public:
   ...
   */
  Status Update(  apollo_msgs::msg::ApollolocalizationLocalizationEstimate localization,
 ...
 private:
  ...
  apollo_msgs::msg::ApollolocalizationLocalizationEstimate original_localization_;
};
