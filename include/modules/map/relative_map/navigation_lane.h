...
namespace apollo
{
  namespace relative_map
  {
    ...
    typedef std::tuple<int, double, double, apollo_msgs::msg::ApollorelativeMapNavigationPath::SharedPtr>
        NaviPathTuple;
    ...
    public:
      ...
      explicit NavigationLane(const apollo_msgs::msg::ApollorelativeMapNavigationLaneConfig &config);
      ~NavigationLane() = default;
       ...
       * @return None.
       */
      void SetConfig(const apollo_msgs::msg::ApollorelativeMapNavigationLaneConfig &config);
       ...
       * @return None.
       */
      void UpdateNavigationInfo(apollo_msgs::msg::ApollorelativeMapNavigationInfo::SharedPtr navigation_info);
       ...
       */
      bool CreateMap(const apollo_msgs::msg::ApollorelativeMapMapGenerationParam &map_config,
    ...
    private:
       ...
       * @return None.
       */
      void ConvertLaneMarkerToPath(const apollo_msgs::msg::ApolloperceptionLaneMarkers &lane_marker,
    ...
    private:
      ...
      apollo_msgs::msg::ApollorelativeMapNavigationLaneConfig config_;

      // received from topic: /apollo/perception_obstacles
      apollo_msgs::msg::ApolloperceptionPerceptionObstacles perception_obstacles_;

      // received from topic: /apollo/navigation
      apollo_msgs::msg::ApollorelativeMapNavigationInfo navigation_info_;
