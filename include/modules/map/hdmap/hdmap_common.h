...
namespace apollo
{
  namespace hdmap
  {
    ...
    {
    public:
      explicit LaneInfo(const apollo_msgs::msg::ApollohdmapLane &lane);

      const Id &id() const { return lane_.id; }
      const Id &road_id() const { return road_id_; }
      const Id &section_id() const { return section_id_; }
      const apollo_msgs::msg::ApollohdmapLane &lane() const { return lane_; }
    ...
    public:
      const apollo_msgs::msg::ApollohdmapLane &lane_;
    ...
    {
    public:
      explicit SignalInfo(const apollo_msgs::msg::ApollohdmapSignal &signal);

      const Id &id() const { return signal_.id; }
      const apollo_msgs::msg::ApollohdmapSignal &signal() const { return signal_; }
      const std::vector<apollo::common::math::LineSegment2d> &segments() const
      {
        return segments_;
      }
    ...
    private:
      const apollo_msgs::msg::ApollohdmapSignal &signal_;
      std::vector<apollo::common::math::LineSegment2d> segments_;
    };
    ...
    {
    public:
      explicit StopSignInfo(const apollo_msgs::msg::ApollohdmapStopSign &stop_sign);

      const Id &id() const { return stop_sign_.id; }
      const apollo_msgs::msg::ApollohdmapStopSign &stop_sign() const { return stop_sign_; }
      const std::vector<apollo::common::math::LineSegment2d> &segments() const
      {
        return segments_;
      }
    ...
    private:
      const apollo_msgs::msg::ApollohdmapStopSign &stop_sign_;
      std::vector<apollo::common::math::LineSegment2d> segments_;
    ...
    public:
      ...
      const apollo_msgs::msg::ApollohdmapObjectOverlapInfo *GetObjectOverlapInfo(const Id &id) const;
    ...
    {
    public:
      explicit RoadInfo(const apollo_msgs::msg::ApollohdmapRoad &road);
      const Id &id() const { return road_.id; }
      const apollo_msgs::msg::ApollohdmapRoad &road() const { return road_; }
      const std::vector<RoadSection> &sections() const { return sections_; }

      const Id &junction_id() const { return road_.junctionid; }
      bool has_junction_id() const { return &road_.junctionid != NULL; }

      const std::vector<RoadBoundary> &GetBoundaries() const;

      apollo::hdmap::Road::Type type() const { return static_cast<apollo::hdmap::Road::Type>(road_.type); }

    private:
      apollo_msgs::msg::ApollohdmapRoad road_;
