...
class Scenario {
 public:
  ...
  Scenario(const apollo_msgs::msg::ApolloplanningScenarioConfig& config, const ScenarioContext* context,
  ...
  int scenario_type() const {
    return config_.scenariotype;
  }
 ...
 protected:
  ...
  apollo_msgs::msg::ApolloplanningScenarioConfig config_;
  std::unordered_map<ScenarioConfig::StageType,
                     const apollo_msgs::msg::ApolloplanningStageConfig*, std::hash<int>>
      stage_config_map_;
