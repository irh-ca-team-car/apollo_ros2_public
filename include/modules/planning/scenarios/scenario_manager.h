...
class ScenarioManager final {
 public:
  ...
  bool Init(const apollo_msgs::msg::ApolloplanningPlanningConfig& planning_config);
 ...
 private:
  ...
  std::unordered_map<ScenarioConfig::ScenarioType, apollo_msgs::msg::ApolloplanningScenarioConfig,
                     std::hash<int>>
      config_map_;
