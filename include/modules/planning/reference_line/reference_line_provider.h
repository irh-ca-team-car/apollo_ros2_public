...
class ReferenceLineProvider {
 public:
  ...
  ReferenceLineProvider(
      ...
      const std::shared_ptr<apollo_msgs::msg::ApollorelativeMapMapMsg>& relative_map = nullptr);
 ...
 private:
  ...
  apollo_msgs::msg::ApolloplanningReferenceLineSmootherConfig smoother_config_;

  std::mutex pnc_map_mutex_;
  std::unique_ptr<hdmap::PncMap> pnc_map_;

  // Used in Navigation mode
  std::shared_ptr<apollo_msgs::msg::ApollorelativeMapMapMsg> relative_map_;
