...
class PublishableTrajectory : public DiscretizedTrajectory {
 public:
   ...
   */
  explicit PublishableTrajectory(const apollo_msgs::msg::ApolloplanningADCTrajectory& trajectory_pb);

  double header_time() const;

  void PopulateTrajectoryProtobuf(apollo_msgs::msg::ApolloplanningADCTrajectory* trajectory_pb) const;
