...
class HistoryObjectDecision {
 public:
  ...
  void Init(const std::string& id,
            const std::vector<apollo_msgs::msg::ApolloplanningObjectDecisionType>& object_decisions);

  const std::string& id() const { return id_; }
  std::vector<const apollo_msgs::msg::ApolloplanningObjectDecisionType*> GetObjectDecision() const;

 private:
  std::string id_;
  std::vector<apollo_msgs::msg::ApolloplanningObjectDecisionType> object_decision_;
};
...
class HistoryFrame {
 public:
  ...
  void Init(const apollo_msgs::msg::ApolloplanningADCTrajectory& adc_trajactory);
 ...
 private:
  int seq_num_;
  apollo_msgs::msg::ApolloplanningADCTrajectory adc_trajactory_;
...
class History {
 public:
  ...
  int Add(const apollo_msgs::msg::ApolloplanningADCTrajectory& adc_trajectory_pb);
  void Clear();
  size_t Size() const;
