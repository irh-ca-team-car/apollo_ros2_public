...
DECLARE_int32(rtk_trajectory_forward);
...
DECLARE_int32(num_sample_follow_per_timestamp);
...
DECLARE_int32(open_space_trajectory_stitching_preserved_length);
...
DECLARE_int32(trajectory_stitching_preserved_length);
