...
class StGraphData {
 public:
  ...
  apollo_msgs::msg::ApolloplanningInternalSTGraphDebug* mutable_st_graph_debug();
  ...
  const apollo_msgs::msg::ApolloplanningSTDrivableBoundary& st_drivable_boundary() const;
 ...
 private:
  ...
  apollo_msgs::msg::ApolloplanningInternalSTGraphDebug* st_graph_debug_ = nullptr;
