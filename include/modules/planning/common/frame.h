...
class Frame {
 public:
  ...
  Frame(uint32_t sequence_num, const LocalView &local_view,
        const apollo_msgs::msg::ApollocommonTrajectoryPoint &planning_start_point,
  ...
  const apollo_msgs::msg::ApollocommonTrajectoryPoint &PlanningStartPoint() const;
  ...
  void RecordInputDebug(planningInternal::Debug *debug);
  ...
  void set_current_frame_planned_trajectory(
      apollo_msgs::msg::ApolloplanningADCTrajectory current_frame_planned_trajectory) {
    current_frame_planned_trajectory_ =
        std::move(current_frame_planned_trajectory);
  }

  const apollo_msgs::msg::ApolloplanningADCTrajectory &current_frame_planned_trajectory() const {
  ...
  bool is_near_destination() const {
  ...
  apollo_msgs::msg::ApolloperceptionTrafficLight GetSignal(const std::string &traffic_light_id) const;
 ...
 private:
  ...
  apollo_msgs::msg::ApollocommonTrajectoryPoint planning_start_point_;
  ...
  std::unordered_map<std::string, const apollo_msgs::msg::ApolloperceptionTrafficLight *>
      traffic_lights_;

  // current frame published trajectory
  apollo_msgs::msg::ApolloplanningADCTrajectory current_frame_planned_trajectory_;
