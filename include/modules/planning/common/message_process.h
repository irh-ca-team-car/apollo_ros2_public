...
class MessageProcess {
 public:
  bool Init(const  apollo_msgs::msg::ApolloplanningPlanningConfig &);
  bool Init(const apollo_msgs::msg::ApolloplanningPlanningConfig &,
            const  std::shared_ptr<DependencyInjector>& injector);

  void Close();

  void OnChassis(const apollo_msgs::msg::ApollocanbusChassis& chassis);

//   void OnHMIStatus(apollo::dreamview::HMIStatus hmi_status);

  void OnLocalization(const apollo_msgs::msg::ApollolocalizationLocalizationEstimate& le);

  void OnPrediction(
      const apollo_msgs::msg::ApollopredictionPredictionObstacles& prediction_obstacles);

  void OnRoutingResponse(
      const apollo_msgs::msg::ApolloroutingRoutingResponse& routing_response);

  void OnStoryTelling(const apollo_msgs::msg::ApollostorytellingStories& stories);
 ...
 private:
  ...
  apollo_msgs::msg::ApolloplanningPlanningConfig planning_config_;
  std::chrono::time_point<std::chrono::system_clock> start_time_;
  std::ofstream log_file_;
  std::string record_file_;
  std::unordered_map<std::string, std::string> map_m_;
  apollo_msgs::msg::ApolloplanningLearningData learning_data_;
  int learning_data_file_index_ = 0;
  std::list<apollo_msgs::msg::ApollolocalizationLocalizationEstimate> localizations_;
  std::unordered_map<int, apollo_msgs::msg::ApollopredictionPredictionObstacle>
      prediction_obstacles_map_;
  std::unordered_map<int, std::list<apollo_msgs::msg::ApolloplanningPerceptionObstacleFeature>>
      obstacle_history_map_;
  apollo_msgs::msg::ApolloplanningChassisFeature chassis_feature_;
  std::string map_name_;
  apollo_msgs::msg::ApolloplanningPlanningTag planning_tag_;
  apollo_msgs::msg::ApolloroutingRoutingResponse routing_response_;
  double traffic_light_detection_message_timestamp_;
  std::vector<apollo_msgs::msg::ApolloplanningTrafficLightFeature> traffic_lights_;
