 ...
 */
  ...
  public:
    ...
    void SetLatticeStopPoint(const apollo_msgs::msg::ApolloplanningStopPoint &stop_point);
    void SetLatticeCruiseSpeed(double speed);
    const apollo_msgs::msg::ApolloplanningPlanningTarget &planning_target() const { return planning_target_; }
   ...
   **/
    ...
    apollo_msgs::msg::ApolloplanningInternalDebug *mutable_debug() { return &debug_; }
    const apollo_msgs::msg::ApolloplanningInternalDebug &debug() const { return debug_; }
    apollo_msgs::msg::ApolloplanningLatencyStats *mutable_latency_stats() { return &latency_stats_; }
    const apollo_msgs::msg::ApolloplanningLatencyStats &latency_stats() const { return latency_stats_; }
    ...
    const apollo_msgs::msg::ApolloplanningRSSInfo &rss_info() const;
    apollo_msgs::msg::ApolloplanningRSSInfo *mutable_rss_info();
   ...
   */
    ...
    void ExportEngageAdvice(apollo_msgs::msg::ApollocommonEngageAdvice *engage_advice,
  ...
  private:
    ...
    void ExportVehicleSignal(apollo_msgs::msg::ApollocommonVehicleSignal *vehicle_signal) const;
  ...
  private:
    ...
    const apollo_msgs::msg::ApollocommonVehicleState vehicle_state_;
    const apollo_msgs::msg::ApollocommonTrajectoryPoint adc_planning_point_;
   ...
   */
    ...
    apollo_msgs::msg::ApolloplanningRSSInfo rss_info_;
   ...
   */
    ...
    apollo_msgs::msg::ApollocommonVehicleSignal vehicle_signal_;
