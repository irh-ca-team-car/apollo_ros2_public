...
namespace apollo
{
    namespace planning
    {
        ...
        {
        public:
            explicit TrajectoryOptimizer(const apollo_msgs::msg::ApolloplanningTaskConfig &config);
            TrajectoryOptimizer(const apollo_msgs::msg::ApolloplanningTaskConfig &config,
