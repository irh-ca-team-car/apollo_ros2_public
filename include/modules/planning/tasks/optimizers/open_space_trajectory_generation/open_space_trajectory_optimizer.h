    ...
    namespace planning
    {
        ...
        public:
            ...
            void UpdateDebugInfo(
                ::apollo::planningInternal::OpenSpaceDebug *open_space_debug);

            apollo::planningInternal::OpenSpaceDebug *mutable_open_space_debug()
            {
        ...
        private:
            ...
            apollo::planningInternal::OpenSpaceDebug open_space_debug_;
        };
    } // namespace planning
} // namespace apollo