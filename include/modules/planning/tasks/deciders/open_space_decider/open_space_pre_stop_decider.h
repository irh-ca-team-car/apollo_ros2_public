...
class OpenSpacePreStopDecider : public Decider {
 public:
  OpenSpacePreStopDecider(const apollo_msgs::msg::ApolloplanningTaskConfig& config,
 ...
 private:
  ...
  apollo_msgs::msg::ApolloplanningOpenSpacePreStopDeciderConfig open_space_pre_stop_decider_config_;
};
