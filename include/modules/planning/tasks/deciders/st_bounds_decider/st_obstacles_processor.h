...
namespace apollo
{
   ...
   */
            bool GetSBoundsFromDecisions(
                ...
                std::vector<
                    std::vector<std::pair<std::string, apollo_msgs::msg::ApolloplanningObjectDecisionType>>> *const
   ...
   */
            void SetObstacleDecision(const std::string &obs_id,
                                     const apollo_msgs::msg::ApolloplanningObjectDecisionType &obs_decision);
   ...
   */
            apollo_msgs::msg::ApolloplanningObjectDecisionType DetermineObstacleDecision(const double obs_s_min,
   ...
   */
        ...
        private:
            ...
            std::unordered_map<std::string, apollo_msgs::msg::ApolloplanningObjectDecisionType> obs_id_to_decision_;
