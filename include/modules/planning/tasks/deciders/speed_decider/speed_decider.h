...
namespace apollo
{
    namespace planning
    {
        ...
        {
        public:
            SpeedDecider(const apollo_msgs::msg::ApolloplanningTaskConfig &config,
   ...
   **/
            bool CreateFollowDecision(const Obstacle &obstacle,
                                      apollo_msgs::msg::ApolloplanningObjectDecisionType *const follow_decision) const;

            /**
   * @brief create yield decision based on the boundary
   **/
            bool CreateYieldDecision(const Obstacle &obstacle,
                                     apollo_msgs::msg::ApolloplanningObjectDecisionType *const yield_decision) const;
