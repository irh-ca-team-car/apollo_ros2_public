...
class FemPosDeviationSmoother {
 public:
     explicit FemPosDeviationSmoother(const apollo_msgs::msg::ApolloplanningFemPosDeviationSmootherConfig &config);
 ...
 private:
     apollo_msgs::msg::ApolloplanningFemPosDeviationSmootherConfig config_;
};
}  // namespace planning
}  // namespace apollo
#endif