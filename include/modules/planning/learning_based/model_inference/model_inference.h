...
namespace apollo
{
   ...
   * @brief Constructor
   */
            explicit ModelInference(const apollo_msgs::msg::ApolloplanningLearningModelInferenceTaskConfig &config)
                : config_(config) {}
   ...
   */
        ...
        protected:
            apollo_msgs::msg::ApolloplanningLearningModelInferenceTaskConfig config_;
        };
