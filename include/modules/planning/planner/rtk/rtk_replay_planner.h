...
class RTKReplayPlanner : public PlannerWithReferenceLine {
 public:
  ...
  apollo::common::Status Init(const apollo_msgs::msg::ApolloplanningPlanningConfig &config) override;
  ...
  apollo::common::Status Plan(
      ...
      apollo_msgs::msg::ApolloplanningADCTrajectory* ptr_computed_trajectory) override;
