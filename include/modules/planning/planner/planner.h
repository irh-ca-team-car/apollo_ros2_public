...
class Planner {
 public:
  ...
  virtual apollo::common::Status Init(const apollo_msgs::msg::ApolloplanningPlanningConfig& config) = 0;
  ...
  virtual apollo::common::Status Plan(
      ...
      apollo_msgs::msg::ApolloplanningADCTrajectory* ptr_computed_trajectory) = 0;
