...
namespace apollo
{
    namespace drivers
    {
        namespace microphone
        {
            ...
            using MicrophoneConfig_ = apollo_msgs::msg::ApollodriversmicrophoneconfigMicrophoneConfig;
 ...
 */
            ...
            private:
                std::unique_ptr<Stream> stream_ptr_;
                 ...
                 PaDeviceIndex host_api_device_index_to_device_index(
                 ...
                 PaDeviceIndex get_respeaker_index() const;
                 PaSampleFormat get_format_from_width(int width,
                                                           bool is_unsigned = true) const;

            public:
                Respeaker() {}
                ~Respeaker();
                void init(const std::shared_ptr<const MicrophoneConfig_> &microphone_config);
                void read_stream(int n_frames, char *buffer) const;
            };
