...
class MPCController : public Controller {
 ...
 protected:
  ...
  bool LoadControlConf(const apollo_msgs::msg::ApollocontrolControlConf *control_conf);

  void InitializeFilters(const apollo_msgs::msg::ApollocontrolControlConf *control_conf);

  void LogInitParameters();

  void ProcessLogs(const SimpleMPCDebug *debug, const apollo_msgs::msg::ApollocanbusChassis *chassis);
