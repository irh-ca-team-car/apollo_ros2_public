...
class LonController : public Controller {
 public:
  ...
  common::Status Init(std::shared_ptr<DependencyInjector> injector,
                      const apollo_msgs::msg::ApollocontrolControlConf *control_conf) override;
 ...
 private:
  ...
  const apollo_msgs::msg::ApollolocalizationLocalizationEstimate *localization_ = nullptr;
  const apollo_msgs::msg::ApollocanbusChassis *chassis_ = nullptr;

  std::unique_ptr<Interpolation2D> control_interpolation_;
  const apollo_msgs::msg::ApolloplanningADCTrajectory *trajectory_message_ = nullptr;
  ...
  const apollo_msgs::msg::ApollocontrolControlConf *control_conf_ = nullptr;
