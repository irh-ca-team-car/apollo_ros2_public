...
class ControllerAgent {
 ...
 private:
   ...
   */
  void RegisterControllers(const apollo_msgs::msg::ApollocontrolControlConf *control_conf);

  common::Status InitializeConf(const apollo_msgs::msg::ApollocontrolControlConf *control_conf);
