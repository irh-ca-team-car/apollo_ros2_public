...
{
public:
  TopoEdge(const apollo_msgs::msg::ApolloroutingEdge& edge, const TopoNode* from_node,
           const TopoNode* to_node);

  ~TopoEdge();

  const apollo_msgs::msg::ApolloroutingEdge &PbEdge() const;
  double Cost() const;
 ...
 private:
   apollo_msgs::msg::ApolloroutingEdge pb_edge_;
