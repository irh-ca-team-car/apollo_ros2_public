...
namespace third_party_perception {
    ...
    {
    public:
        explicit ThirdPartyPerception(apollo::cyber::ComponentBase *const node);
        ...
        void OnChassis(const apollo_msgs::msg::ApollocanbusChassis &message);
    ...
    protected:
        ...
        std::shared_ptr<apollo::cyber::ComponentBase> node_ = nullptr;
        std::shared_ptr<
